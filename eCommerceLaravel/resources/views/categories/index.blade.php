                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="{{ url('assets/images/women-01.jpg') }}" alt="">
                            </div>
                            <div class="down-content">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="{{ url('assets/images/women-02.jpg') }}" alt="">
                            </div>
                            <div class="down-content">
                                <h4>Classic Dress</h4>
                                <span>$45.00</span>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="{{ url('assets/images/kid-01.jpg') }}" alt="">
                            </div>
                            <div class="down-content">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="{{ url('assets/images/kid-02.jpg') }}" alt="">
                            </div>
                            <div class="down-content">
                                <h4>Summer Cap</h4>
                                <span>$12.00</span>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="{{ url('assets/images/kid-03.jpg') }}" alt="">
                            </div>
                            <div class="down-content">
                                <h4>Classic Kid</h4>
                                <span>$30.00</span>
