...
INSERT INTO `managementpqrs` (`id`, `description`, `state`, `typePqrs_id`, `user_id`, `created_at`, `updated_at`) VALUES
(2, 'la página funciona re bien :]', '0', 6, 4, NULL, NULL);
...
INSERT INTO `products` (`id`, `name`, `price`, `description`, `garanty`, `total_stock`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `products_shirtcolors` (`product_id`, `shirtcolor_id`, `image`, `stock`) VALUES
(3, 5, NULL, 5),
(3, 6, NULL, 5),
(4, 6, NULL, 5),
(4, 7, NULL, 5);
